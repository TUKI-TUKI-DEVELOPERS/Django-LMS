...
urlpatterns = [
    ...
    # Department heads
    path("dep-heads/", dep_head_list_view, name="dep_head_list"),
    path("dep-head/add/", dep_head_add_view, name="add_dep_head"),
    ...
    path("ajax/user-count/", user_count, name="user_count"),
    # paths to pdf
    path(
